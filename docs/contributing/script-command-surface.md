...
| Source CLI                  | `bin/harness.ts`             | `harness init`, `harness factory status`, `harness factory triage`, `harness run change-review`, `harness run factory-triage`, `harness run plan-review`, `harness runs prune`, `harness models`, `harness skills install` | User-facing harness workflow commands and local factory inbox management. Workflow implementations live in `workflows/*.workflow.ts`.                          |
...
| Factory artifact writing        | `harness run factory-triage`, `harness factory triage`                                                                                                                                                           | Live and dry-run factory triage commands write ignored run artifacts under `.harness/runs/factory/<run-id>/`. Dry-run writes placeholders and does not invoke a provider.                                                                                                                    |

...
| Factory system smoke        | `scripts/smoke-factory.ts`   | `pnpm smoke:factory`, `make smoke-factory`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Verify one offline full-chain Factory journey across separate source-CLI processes.                                                                                             |
...
| Ephemeral system mutation               | `make smoke-factory`, `pnpm smoke:factory`                                                                                                                                                                                                                                                                 | Creates a temporary Git repository, bare remote, isolated Factory store, local fake-boundary logs, commits, refs, and publication state. Success removes them; failure prints and retains their paths for diagnosis. No user Factory store or live service is used.                                                                                                                                                                                                                                                                                                                                |

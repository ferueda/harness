...
| Factory system smoke        | `scripts/smoke-factory.ts`, `scripts/smoke-factory-grove.ts` | `pnpm smoke:factory`, `make smoke-factory`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Verify the offline full-chain Factory journey and Grove acquire, restart/reopen, evidence preservation, and terminal release.                                                   |
...
| Ephemeral system mutation               | `make smoke-factory`, `pnpm smoke:factory`                                                                                                                                                                                                                                                                 | Creates temporary Git repositories, bare remotes, an isolated Grove pool and Factory store, local fake-boundary logs, commits, refs, and publication state. Success removes them; failure prints and retains their paths for diagnosis. No user Grove pool, Factory store, or live service is used.                                                                                                                                                                                                                                                                                                |

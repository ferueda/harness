...
| Factory system smoke        | `scripts/smoke-factory.ts`, `scripts/smoke-factory-grove.ts` | `pnpm smoke:factory`, `make smoke-factory`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Verify the offline full-chain Factory journey and hosted Grove execution, terminal release, identifier-only replay recovery, and evidence preservation.                         |

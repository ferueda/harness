...
| Factory system smoke        | `scripts/smoke-factory.ts`, `scripts/smoke-factory-grove.ts` | `pnpm smoke:factory`, `make smoke-factory`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Verify the offline full-chain journey and local Inngest Dev Server + Connect delivery, hosted Grove execution, terminal release, identifier-only replay recovery, and evidence preservation. |
...
| Ephemeral system mutation               | `make smoke-factory`, `pnpm smoke:factory`                                                                                                                                                                                                                                                                                    | Creates temporary Git repositories, bare remotes, an isolated Grove pool and Factory store, local fake-boundary logs, commits, refs, publication state, and a pinned Inngest Dev Server on allocated loopback ports. Success removes them and stops child processes; failure prints bounded retained diagnostics. No user Grove pool, Factory store, or external service is used.                                                                                                                                                                                                                  |

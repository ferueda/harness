...
| Ephemeral system mutation               | `make smoke-factory`, `pnpm smoke:factory`, `make smoke-linear-automation`, `pnpm smoke:linear-automation`                                                                                                                                                                                                                    | Creates temporary repositories or workspaces and local Inngest processes. Success cleans them; failure retains bounded diagnostics. It does not touch user state or external services.                                                                                                                                                                                                                                                                                                                                                                                                             |

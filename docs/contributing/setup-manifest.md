...
Compose volume. Keep Grove controller clones, leases, worktrees, and warm
ignored dependencies in the repository-data volume. Keep package downloads in
the package-manager-cache volume. The optional Codex credential volume remains
separate from both.

...
| File                                                                                             | Status | Summary                                                                  |
| ------------------------------------------------------------------------------------------------ | ------ | ------------------------------------------------------------------------ |
| [260704-factory-github-inngest-architecture.md](./260704-factory-github-inngest-architecture.md) | `open` | Future GitHub Issues tracker and Inngest orchestration architecture      |
| [260704-factory-planner-station.md](./260704-factory-planner-station.md)                         | `open` | Factory ready-to-plan station, planner ownership, session reuse loop     |

...
| File                                                                                             | Status | Summary                                                                  |
| ------------------------------------------------------------------------------------------------ | ------ | ------------------------------------------------------------------------ |
| [260704-factory-github-inngest-architecture.md](./260704-factory-github-inngest-architecture.md) | `open` | Future GitHub Issues tracker, Inngest orchestration, and plan metadata   |
| [260704-factory-planner-station.md](./260704-factory-planner-station.md)                         | `open` | Factory ready-to-plan station, plan PR handoff, metadata, session loop   |
| [260704-factory-adapters-orchestration.md](./260704-factory-adapters-orchestration.md)           | `open` | Linear/GitHub adapter, plan PR metadata, and Inngest boundaries          |

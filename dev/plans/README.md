...
Manual plans use `YYMMDD-short-slug.md`. Reconcile the active queue before
adding one. Record the intended outcome, source revision, status, and
dependencies when needed for safe continuation.

...
import { findHarnessConfig, initHarnessConfig, resolveHarnessOptions } from "../lib/config.js";
...
test("initHarnessConfig creates harness.json and ignores run artifacts", () => {
  ...
  assert.equal(readFileSync(join(workspace, ".gitignore"), "utf8"), ".harness/runs/\n");
});

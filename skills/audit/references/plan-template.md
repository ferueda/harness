...
> in `dev/plans/README.md` — unless a reviewer dispatched you and told you they
> maintain the index.
>
...
- Branch: `advisor/YYMMDD-<slug>` (or the repo's branch-naming convention if one is evident)
...
Generated by the audit skill on <date>. Execute in the order below unless
...
| 260621-refactor-orders | ... | P1 | M | 260621-fix-n-plus-one | TODO |

Status values: TODO | IN PROGRESS | DONE | BLOCKED (with one-line reason) | REJECTED (with one-line rationale — finding fixed independently or approach abandoned)

## Dependency notes

- `260621-refactor-orders` requires `260621-fix-n-plus-one` because <reason>.
